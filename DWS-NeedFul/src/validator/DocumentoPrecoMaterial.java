...
public class DocumentoPrecoMaterial extends JFormattedTextField {
	...
	public DocumentoPrecoMaterial(int casasDecimais) {
		this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
	}

	public DocumentoPrecoMaterial() {
		this(MONETARY_FORMAT);
	}

	public DocumentoPrecoMaterial(NumberFormat format) {
		numberFormat = format;
		...
		setDocument(new PlainDocument() {
			...
			public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
				String text = new StringBuilder(DocumentoPrecoMaterial.this.getText().replaceAll("[^0-9]", ""))
